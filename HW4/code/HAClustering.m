...
%           point X(i, :) has been assigned to cluster c.
    ...
    while num_clusters > k
        ...
        %                                                                     %
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        iclusterSize = cluster_sizes(i);
        jclusterSize = cluster_sizes(j);
        
        numPointsinCluster = iclusterSize + jclusterSize;
        centroids(i, :) = (iclusterSize * centroids(i, :) + jclusterSize * centroids(j, :))  ./ numPointsinCluster;
        centroids(j, :) = +Inf;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %                                                                     %
        %                            END YOUR CODE                            %
        ...
        ijdist = pdist2(centroids(i,:), centroids);
        dists(i, :) = ijdist;
        dists(:, i) = ijdist;
